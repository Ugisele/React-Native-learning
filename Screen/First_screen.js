...
<View style={Styles.container}>
    ...
    <View >
        ...
        <View style={Styles.input}>
             ...
             <TextInput style={{backgroundColor: '#f7f7f7',borderWidth: 0,borderRadius: 50,borderTopRightRadius: 50,borderTopLeftRadius: 50,
         borderBottomEndRadius:50,borderBottomLeftRadius:50,}}
             label="Email"
             mode="flat"
             placeholder='example@gmail.com'
             left={<TextInput.Icon icon="email-outline" color={'#e355fd'} size={25} style={{backgroundColor: '#f8d3fe',
             borderRadius:50}}/>} />
             
        </View>
        <View >
         
         <TextInput style={{backgroundColor: '#f7f7f7',borderWidth: 0,borderTopLeftRadius: 50,borderTopRightRadius: 50, 
